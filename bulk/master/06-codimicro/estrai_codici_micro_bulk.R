################################################################################
# SERVIZIO MASSIVO PER ASSOCIAZIONE A COORDINATE DEI CODICI DEI MICROTERRITORI #
################################################################################
...
# fn <- file.path(percorsi$smb, 'master', 'bulk', 'codimicro', 'invio', 'test.csv')
...
yr <- y |> masteRgeo::trova_codici_micro()
